...
Kurmak için [NuGet (https://www.nuget.org/packages/TS.BorsaTakipSistemi)](https://www.nuget.org/packages/TS.BorsaTakipSistemi/) burayı ziyaret edebilirsiniz

Ya da aşağıdaki kod bloğunu çalıştırarak kurabilirsiniz

```powershell
dotnet new install TS.BorsaTakipSistemi
```

kurulum bittikten sonra `dotnet new list` ile VS2022 proje listesini görüntüleyip "ASP.NET Clean Architecture Solution" kısa adı "ts.borsatakipsistemi" proje template'ini arayabilirsiniz. Eğer listede bulduysanız artık VS2022 üzerinden yeni proje oluştur deyip proje arama çubuğunda "Clean Architecture" diye arayarak bulabilirsiniz.

![Proje Template](https://github.com/TanerSaydam/BorsaTakipSistemi.Template/blob/main/images/projeyibulma.png)

Projeyi seçtikten sonra istediğiniz ismi verin örneğin `eCommerce`

![Proje Structure](https://github.com/TanerSaydam/BorsaTakipSistemi.Template/blob/main/images/projestructure.png)
...
![Connection String](https://github.com/TanerSaydam/BorsaTakipSistemi.Template/blob/main/images/connectionstring.png)
...
![Create First User](https://github.com/TanerSaydam/BorsaTakipSistemi.Template/blob/main/images/createfirstuser.png)
